...
exports.handleDealing = handleDealing;
exports.handleFirstPlay = handleFirstPlay;
exports.handlePlayCard = handlePlayCard;
exports.handlePass = handlePass;
exports.handlePlayFromControl = handlePlayFromControl;
exports.handleWin = handleWin;
const deck_js_1 = require("../deck.js");
const combos = __importStar(require("./combos"));
function updateGameState(phase, seats, seatIndex, players, winners) {
    return {
        phase: phase,
        seats: seats,
        seatIndex: seatIndex,
...
function updateRoundState(prev, updates) {
    return {
        ...prev,
        ...updates,
...
function findNextPlayer(state, round, currentPlayer) {
...
function handleFirstPlay(state, player, selectedCombo) {
...
function handlePlayCard(state, player, selectedCombo) {
...
function handlePlayFromControl(state, player, selectedCombo) {
    if (state.phase.type !== 'Round') {
...
function handleWin(state, player) {
